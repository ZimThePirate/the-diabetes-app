        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptySubtitle}>Please complete your profile setup first.</Text>
                </View>
            </View>
        );
    }
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.bmiContainer}>
                            ...
                            <Text style={styles.bmiValue}>
                                {(parseFloat(userDetails.weight) / Math.pow(parseFloat(userDetails.height) / 100, 2)).toFixed(1)}
                            </Text>
                        </View>
                    </View>
                </View>
